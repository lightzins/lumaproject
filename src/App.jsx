...
const Hero = ({ onStart }) => {
  ...
  return (
    <section className="min-h-[100svh] w-full p-0 md:p-6 bg-primary md:bg-background flex flex-col">
      <div 
        ref={containerRef}
        className="relative flex-1 w-full min-h-[90svh] md:min-h-0 rounded-none md:rounded-[3rem] overflow-hidden flex flex-col justify-end p-6 pb-28 md:p-20"
      >
        {/* Background Image */}
        <div 
          ref={imgRef}
        ...
        <div className="relative z-20 w-full flex flex-col md:flex-row items-start md:items-end justify-between gap-6 md:gap-12">
          ...
          <div className="w-full md:max-w-sm text-left md:text-right flex flex-col items-start md:items-end mt-4 md:mt-0">
            ...
            <button 
              onClick={onStart}
              className="reveal-item w-full md:w-auto bg-background text-primary pl-8 pr-2 py-2 rounded-full font-black text-xs uppercase tracking-widest flex items-center justify-center gap-6 hover:scale-105 transition-all duration-500 shadow-xl"
            >
